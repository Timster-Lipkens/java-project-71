...
public class Differ {
    ...
    public static Object generate(String filepath1, String filepath2, String format) throws Exception {
        TreeMap<String, Object> sortedMap1 = new TreeMap<>(Parser.getData(filepath1)); //авто-сортировка от дерева.
        TreeMap<String, Object> sortedMap2 = new TreeMap<>(Parser.getData(filepath2));
